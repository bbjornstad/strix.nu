...
let punct_delimited_words = r#'(?>\w+[[:punct:]]?)+'#
let whitespace_delimited_words = r#'(?>\w+[[:blank:]]?)+'#
let section = r#'^(?<section>{{REPLACE}})'#
| str replace '{{REPLACE}}' $whitespace_delimited_words
